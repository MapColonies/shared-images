...
function editHeaders(r) {
    ...
    if ('headersOut' in r) {
        // r.headersOut['Cross-Origin-Resource-Policy'] = 'cross-origin';         
        // r.headersOut['Cross-Origin-Embedder-Policy'] = 'same-origin';         
        // r.headersOut['Cross-Origin-Opener-Policy'] = 'cross-origin';
